...
```
/**
 * struct binary_tree_s - Binary tree nofe
...
* __Matilda Dogbatsey__ <[kafui_praise](https://github.com/KafuiPraise)>
* __Freda Tsorme-Dzebu__ <[Freda Tsorme-Dzebu](https://github.com/Kelys3)>
